    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <Card className="space-y-8" animate={false}>
        ...
        <div className="grid gap-4 sm:p-5 lg:p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between p-4 sm:p-5 lg:p-6 rounded-3xl bg-white/[0.02] border border-white/5 group hover:border-white/10 transition">
            <div className="flex items-center gap-4 sm:p-5 lg:p-6">
              ...
              <div>
                <p className="text-lg font-black text-white break-words/80">•••• •••• •••• 4242</p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between p-4 sm:p-5 lg:p-6 rounded-3xl bg-white/[0.02] border border-white/5 group hover:border-white/10 transition opacity-50 grayscale">
            <div className="flex items-center gap-4 sm:p-5 lg:p-6">
              ...
              <div>
                <p className="text-lg font-black text-white break-words/80">oluwa***@gmail.com</p>
      ...
      <Card className="bg-emerald-500/[0.02] border-emerald-500/20" animate={false}>
        <div className="flex items-start gap-4 sm:p-5 lg:p-6">
          <div className="grid h-11 w-11 sm:h-12 sm:w-12 place-items-center rounded-2xl bg-emerald-500/10 text-emerald-400 flex-shrink-0">
            <ShieldCheck size={24} />
          </div>
          <div>
